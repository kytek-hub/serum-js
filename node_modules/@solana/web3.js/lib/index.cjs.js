  ...
  _createClass__default['default'](Transaction, [{
    ...
    value: function signPartial() {
      ...
      partialSigners.forEach(function (accountOrPublicKey, index) {
        ...
        if (account) {
          var signature = nacl__default['default'].sign.detached(signData, account.secretKey);
...
var Connection = /*#__PURE__*/function () {
  ...
  _createClass__default['default'](Connection, [{
    ...
    value: function () {
      var _confirmTransaction = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee19(signature, confirmations) {
    ...
    value: function _wsOnOpen() {
      ...
      this._rpcWebSocketHeartbeat = setInterval(function () {
        ...
        _this._rpcWebSocket.notify('ping')["catch"](function () {});
      }, 5000);
